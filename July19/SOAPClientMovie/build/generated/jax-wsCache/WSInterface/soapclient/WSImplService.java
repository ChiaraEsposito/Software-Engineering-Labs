 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://soapmovieservice.softeng.sapienza.it/", wsdlLocation = "http://localhost:8080/WSInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://soapmovieservice.softeng.sapienza.it/", "WSImplService");
    ...
    public WSInterface getWSImplPort() {
        return super.getPort(new QName("http://soapmovieservice.softeng.sapienza.it/", "WSImplPort"), WSInterface.class);
    }
    ...
    public WSInterface getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapmovieservice.softeng.sapienza.it/", "WSImplPort"), WSInterface.class, features);
    }
