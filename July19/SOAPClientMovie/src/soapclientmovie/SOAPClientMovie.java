    ...
    public static void main(String[] args)throws ClassNotFoundException_Exception, SQLException_Exception {
        ...
        while(!exit){
            ...
            if (inserted.equals("exit")) {
                ...
                System.out.println("Movie:" + mv.getId() + " is " + mv.getTitle() + "(" + mv.getYear() + ")");
                System.out.println("Directed by:" + dir.getName() + "(" + dir.getBirth()+ ")");
            }
            else {
